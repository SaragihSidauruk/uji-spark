...
//
// Debug information:
// Generated date: Mon Oct 09 23:33:02 PDT 2017
...
public class country extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("Continent", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
    ...
    setters.put("SurfaceArea", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        SurfaceArea = (Float)value;
      }
    });
    setters.put("IndepYear", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        IndepYear = (Integer)value;
      }
    });
    setters.put("Population", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        Population = (Integer)value;
      }
    });
    setters.put("LifeExpectancy", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LifeExpectancy = (Float)value;
      }
    });
    setters.put("GNP", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        GNP = (Float)value;
      }
    });
    setters.put("GNPOld", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        GNPOld = (Float)value;
      }
    });
    setters.put("LocalName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        LocalName = (String)value;
      }
    });
    setters.put("GovernmentForm", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        GovernmentForm = (String)value;
      }
    });
    setters.put("HeadOfState", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        HeadOfState = (String)value;
      }
    });
    setters.put("Capital", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        Capital = (Integer)value;
      }
    });
    setters.put("Code2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        Code2 = (String)value;
      }
